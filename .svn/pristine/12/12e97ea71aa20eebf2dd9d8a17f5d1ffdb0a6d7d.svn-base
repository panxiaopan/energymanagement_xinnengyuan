      ...
      <div class="hj-task-details__body__relatedInfo" v-if="relatedInfo">
        ...
        <div class="related-body">
          <div class="related-body__item">
            ...
            <span :class="[normalClass]">{{computedRelatedDesc}}</span>
          </div>
          <div class="related-body__item">
...
<script>
import { getflowDetail } from "@/api/api";
  ...
  computed: {
    ...
    basicInfo() {
      ...
      if (workOrderVO) {
        ...
        socialUnit =
          (workOrderVO.socialUnit && workOrderVO.socialUnit.name) || "";
        address =
          (workOrderVO.socialUnit && workOrderVO.socialUnit.address) || "";
