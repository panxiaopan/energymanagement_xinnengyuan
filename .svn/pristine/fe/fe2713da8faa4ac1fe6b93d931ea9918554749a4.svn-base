      ...
      <el-container>
        <el-aside width="270px">
          <el-col>
            ...
            <el-tree :data="chirdenstationdata" :props="defaultProps" >
  ...
  data() {
    return {
      ...
      submenuData: [
        {
          name: "能源综合总汇",
          path: `/mastertion/${this.$route.params.type}/${this.$route.params.id}`,
          submenuDatachirden: []
        },
        {
          name: "子站列表",
